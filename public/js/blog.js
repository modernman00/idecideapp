...
(0,_global_js__WEBPACK_IMPORTED_MODULE_0__.id)('button').addEventListener('click', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          e.preventDefault();
          form = (0,_global_js__WEBPACK_IMPORTED_MODULE_0__.id)('createPostForm');
          formData = new FormData(form);
          titleError = (0,_global_js__WEBPACK_IMPORTED_MODULE_0__.id)('title_error');
          contentError = (0,_global_js__WEBPACK_IMPORTED_MODULE_0__.id)('content_error');
          _context.p = 1;
          _context.n = 2;
          return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/createBlog', formData, {
            headers: {
        ...
        case 2:
          ...
          (0,_global_js__WEBPACK_IMPORTED_MODULE_0__.id)('notification').textContent = _response.data.message;
          // background color
          (0,_global_js__WEBPACK_IMPORTED_MODULE_0__.id)('notification').style.backgroundColor = 'green';
        ...
        case 3:
          ...
          if (errorMsg.includes('title')) {
            ...
            (0,_global_js__WEBPACK_IMPORTED_MODULE_0__.id)('notification').textContent = response.data.message;
            // background color
            (0,_global_js__WEBPACK_IMPORTED_MODULE_0__.id)('notification').style.backgroundColor = 'red';
          }
        case 4:
          return _context.a(2);
      }
...
var textarea = (0,_global_js__WEBPACK_IMPORTED_MODULE_0__.id)('content_id');
textarea.rows = 10;
